...
def tfidf(data_set, space_path):
    if os.path.exists(space_path):
        ...
        tfidf_space = transformer.fit_transform(data_set)
...
def plot_pr(auc_score, precision, recall, label=None):
    ...
    pylab.savefig('data/R_P.png')


if __name__ == '__main__':
    # data
    train_data_path = "data/train/train_seg.txt"  # 输入的文件
    test_data_path = "data/test/test_seg.txt"  # 输入的文件
    space_path = "data/tfidf.dat"  # 输出的文件
